...
import { Tooltip, Modal, Button, Text, Group } from '@mantine/core';
import { IconBook, IconApple, IconBrush, IconPencil } from '@tabler/icons-react';
...
const StartModal: React.FC<StartModalProps> = ({ isOpen, onClose, onSelect }) => {
    ...
    return (
        <Modal opened={isOpen} onClose={onClose} size="lg" title="体験を始めます" centered>
            <Text>体験を開始する方法を選んでください．テンプレートを選択することも，自分で書くこともできます．</Text>
                        ...
                        <Button
                            ...
                            styles={{
                                root: {
                                    width: '80px',
                                    height: '92px',
                                    background: hoveredOption === option.value
                                    ...
                                    transform: hoveredOption === option.value ? 'scale(1.1)' : 'scale(1)',
                                    ...
                                    //perspective: '1000px',
                                    filter: hoveredOption === option.value ? 'drop-shadow(0 0px 10px rgba(0, 0, 0, 0.25))' : 'drop-shadow(0 0px 10px rgba(0, 0, 0, 0.1))',
                                },
                                label: {
                                    fontWeight: 'bold',
